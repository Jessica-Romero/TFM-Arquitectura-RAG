...
El repositorio incluye un modo de ejecución interactivo mediante la función chat_interactive(), que permite consultar el sistema RAG Multimodal de forma directa desde la consola.
