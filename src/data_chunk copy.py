...
def save_to_csv(sections: list[dict], csv_path: str | Path):
    """
...
if __name__ == "__main__":
    ...
    save_to_csv(doc_list,"C:\Users\jessi\OneDrive\Escritorio\MÁSTER-UOC\TFM\TFM-Arquitectura-RAG\TFM-Arquitectura-RAG\src\chunks_rutas_aiguaneix_por_subtitulos.csv")
