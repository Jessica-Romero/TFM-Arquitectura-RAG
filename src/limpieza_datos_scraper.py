...
def load_and_clean_data(file_path: str) -> pd.DataFrame:
   ...
   # Comprobar duplicados por enlace 
    ...
    DOWNLOAD_DIR = 'D:\\TFM\\TFM-Arquitectura-RAG\\TFM-Arquitectura-RAG\\data\\rutas_pdf'
    ...
    OUTPUT_DIR = r".\src"
    OUTPUT_FILE = os.path.join(OUTPUT_DIR, "rutas.csv")
...
if __name__ == "__main__":
    df = load_and_clean_data(file_path="./rutas_scraper.csv")